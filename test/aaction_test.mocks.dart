...
// in jean_jean/test/aaction_test.dart.
...
class MockApiService extends _i1.Mock implements _i2.ApiService {
  ...
  @override
  _i3.Future<List<_i4.Acteur>> fetchMarkers(
    double? latitude,
    double? longitude,
    List<int>? actionIds,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i3.Future<List<_i4.Acteur>>.value(<_i4.Acteur>[]),
      ) as _i3.Future<List<_i4.Acteur>>);

  @override
  _i3.Future<List<dynamic>> fetchActions() => (super.noSuchMethod(
        Invocation.method(
          #fetchActions,
          [],
        ),
